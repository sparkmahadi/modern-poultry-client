...
const TruckLoaderAuthenticating = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] w-full bg-slate-50 rounded-xl">
      <div className="flex items-center justify-center">
        <div className="w-[200px] h-[100px] flex flex-col relative items-center justify-end overflow-x-hidden">
          
          {/* Truck Body */}
          <div className={`${styles.truckBody} w-[130px] mb-[6px]`}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 198 93">
              ...
              <circle fill="#282828" cx="146.5" cy="65" r="3.5" />
          ...
          {/* Tires */}
          <div className="w-[130px] flex items-center justify-between px-[10px] pl-[15px] absolute bottom-0 z-10">
            {[1, 2].map((i) => (
              <svg key={i} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 30 30" className="w-6">
          ...
          {/* Road */}
          <div className={`${styles.road} w-full h-[1.5px] bg-[#282828] relative bottom-0 self-end rounded-full`} />

          {/* Lamp Post */}
          <svg viewBox="0 0 453.459 453.459" xmlns="http://www.w3.org/2000/svg" className={`${styles.lampPost} absolute bottom-0 right-[-90%] h-[90px] fill-[#282828]`}>
      ...
      {/* Loading Text */}
      <div className="mt-4 text-slate-600 font-bold uppercase tracking-widest text-xs animate-pulse">
        Authenticating......
      </div>
    </div>
  );
...
export default TruckLoaderAuthenticating;