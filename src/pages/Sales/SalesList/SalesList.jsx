...
const SalesList = () => {
  ...
  return (
    <div className="p-4 max-w-6xl mx-auto">
      ...
      {memos.length === 0 && <div className="p-8 max-w-6xl mx-auto text-center text-gray-500 bg-white rounded-xl shadow-lg">
                ...
                {memos.map((memo) => (
                  <React.Fragment key={memo._id}>
                    ...
                    <tr className="hover:bg-gray-50 transition-colors cursor-pointer" onClick={() => toggleExpand(memo._id)}>
                      ...
                      <td className={`px-6 py-4 whitespace-nowrap text-sm text-right font-bold ${memo.due > 0 ? 'text-red-600' : 'text-green-600'
                        }`}>
