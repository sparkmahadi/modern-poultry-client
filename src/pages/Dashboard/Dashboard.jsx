...
const Dashboard = () => {
  ...
  const Sidebar = () => (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-30 transform bg-white w-64 p-5 shadow-2xl lg:relative lg:translate-x-0 lg:shadow-none transition-transform duration-300 ${
