...
const CustomerBatchList = ({batches}) => {
              ...
              {batches.map((batch) => (
                <tr key={batch._id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                    <Link to={`/farm-batches/${batch._id}`} className="text-indigo-600 hover:text-indigo-900">View Details</Link>
...
export default CustomerBatchList;